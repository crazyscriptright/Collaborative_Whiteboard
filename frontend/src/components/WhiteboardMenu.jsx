        ...
        <div className="flex items-center gap-2 sm:gap-4">
          ...
          <div className="relative" ref={notificationRef}>
            <button
              ...
              className="p-1 rounded-full hover:bg-gray-100 text-gray-600 relative"
            >
            ...
            {showNotifications && (
              <div className="absolute top-full right-0 mt-2 w-80 bg-white rounded-lg shadow-xl border border-gray-100 py-2 z-50 animate-in fade-in zoom-in-95 duration-100">
